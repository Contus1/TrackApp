// Configuration exactly like the working birthday-reminder project
...
console.log('📝 Using hardcoded Supabase configuration (like birthday-reminder)');

console.log('📝 Using Supabase configuration (production mode)');
